...
* **Average SOAP Cosine Similarity**: `0.9945`
* **Median SOAP Cosine Similarity**: `0.9982`
* **Average SOAP Fingerprint RMSD**: `0.0287`
* **Median SOAP Fingerprint RMSD**: `0.0220`
* **Total Zn Centers Analyzed**: `9176`

| Similarity Range | Category | Count | Percentage | Description |
| :--- | :--- | :---: | :---: | :--- |
| **$\ge 0.98$** | Highly Represented | 8743 | **95.28%** | Local environment is almost perfectly preserved in the fragment library. |
| **$[0.90, 0.98)$** | Moderately Represented | 421 | **4.59%** | Local environment is structurally similar, with minor variations (e.g. capped bonds, minor coordinates shift). |
...
| :---: | :---: | :---: | :---: | :---: | :--- |
| 1 | `REDYEG` | 1 | `0.7926` | `0.1819` | `REDYEGFragMof` |
| 2 | `REDYEG` | 0 | `0.7926` | `0.1819` | `REDYEGFragMof` |
| 3 | `REDYEG` | 2 | `0.8297` | `0.1696` | `REDYEGFragMof` |
| 4 | `REDYEG` | 4 | `0.8297` | `0.1696` | `REDYEGFragMof` |
| 5 | `REDYEG` | 5 | `0.8297` | `0.1696` | `REDYEGFragMof` |
| 6 | `REDYEG` | 3 | `0.8297` | `0.1696` | `REDYEGFragMof` |
| 7 | `RUMRUO` | 1 | `0.8520` | `0.2558` | `OQOXAVFragMof` |
| 8 | `RUMRUO` | 0 | `0.8520` | `0.2558` | `OQOXAVFragMof` |
| 9 | `OQOXAV` | 4 | `0.8520` | `0.2577` | `OQOXAVFragMof` |
| 10 | `OQOXAV` | 2 | `0.8520` | `0.2577` | `OQOXAVFragMof` |
| 11 | `OQOXAV` | 5 | `0.8520` | `0.2577` | `OQOXAVFragMof` |
| 12 | `OQOXAV` | 3 | `0.8520` | `0.2577` | `OQOXAVFragMof` |
| 13 | `MOMRIR` | 6 | `0.9100` | `0.2034` | `CACBUGFragMof` |
| 14 | `MOMRIR` | 8 | `0.9100` | `0.2034` | `CACBUGFragMof` |
| 15 | `MOMRIR` | 7 | `0.9100` | `0.2034` | `CACBUGFragMof` |
| 16 | `MOMRIR` | 9 | `0.9100` | `0.2034` | `CACBUGFragMof` |
| 17 | `MOMRIR` | 14 | `0.9110` | `0.2024` | `CACBUGFragMof` |
| 18 | `MOMRIR` | 15 | `0.9110` | `0.2024` | `CACBUGFragMof` |
| 19 | `XATZOK` | 3 | `0.9114` | `0.3880` | `CEFKACFragMof` |
| 20 | `XATZOK` | 0 | `0.9114` | `0.3880` | `CEFKACFragMof` |
| 21 | `FIDMEL` | 2 | `0.9205` | `0.1789` | `FIDMELFragMof` |
| 22 | `WAWGOQ` | 5 | `0.9206` | `0.3743` | `CEFKACFragMof` |
| 23 | `WAWGOQ` | 0 | `0.9206` | `0.3743` | `CEFKACFragMof` |
| 24 | `WAWGOQ` | 1 | `0.9206` | `0.3743` | `CEFKACFragMof` |
| 25 | `WAWGOQ` | 4 | `0.9206` | `0.3743` | `CEFKACFragMof` |
