...
| :---: | :---: | :---: | :---: | :--- |
| 1 | `REDYEG` | 1 | `0.8010` | `REDYEGFragMof` |
| 2 | `REDYEG` | 0 | `0.8010` | `REDYEGFragMof` |
| 3 | `REDYEG` | 2 | `0.8105` | `REDYEGFragMof` |
| 4 | `REDYEG` | 4 | `0.8105` | `REDYEGFragMof` |
| 5 | `REDYEG` | 5 | `0.8105` | `REDYEGFragMof` |
| 6 | `REDYEG` | 3 | `0.8105` | `REDYEGFragMof` |
| 7 | `FIDMEL` | 2 | `0.8752` | `FIDMELFragMof` |
| 8 | `FIDMEL` | 0 | `0.8768` | `FIDMELFragMof` |
| 9 | `FIDMEL` | 3 | `0.8769` | `FIDMELFragMof` |
| 10 | `FIDMEL` | 5 | `0.8771` | `FIDMELFragMof` |
| 11 | `FIDMEL` | 4 | `0.8778` | `FIDMELFragMof` |
| 12 | `FIDMEL` | 1 | `0.8782` | `FIDMELFragMof` |
| 13 | `RUMRUO` | 0 | `0.8857` | `OQOXAVFragMof` |
| 14 | `RUMRUO` | 1 | `0.8857` | `OQOXAVFragMof` |
| 15 | `OQOXAV` | 3 | `0.8863` | `OQOXAVFragMof` |
| 16 | `OQOXAV` | 2 | `0.8863` | `OQOXAVFragMof` |
| 17 | `OQOXAV` | 5 | `0.8863` | `OQOXAVFragMof` |
| 18 | `OQOXAV` | 4 | `0.8863` | `OQOXAVFragMof` |
| 19 | `XATZOK` | 0 | `0.9147` | `CEFKACFragMof` |
| 20 | `XATZOK` | 3 | `0.9147` | `CEFKACFragMof` |
| 21 | `IYOQAQ` | 0 | `0.9253` | `DAFSOVFragMof` |
| 22 | `IYOQAQ` | 1 | `0.9253` | `DAFSOVFragMof` |
| 23 | `FIDMEL` | 7 | `0.9297` | `FIDMELFragMof` |
| 24 | `LACJAC` | 0 | `0.9327` | `WEVDUAFragMofMin` |
| 25 | `WAWGOQ` | 5 | `0.9345` | `CEFKACFragMof` |
